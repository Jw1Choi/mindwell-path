$(function() {
  var targetDate = new Date("2025-05-08T23:59:00+09:00");
    var today=new Date("2025-05-08T23:59:00+09:00");
    ...
    var x = setInterval(function() {
      ...
      // ✅ 일 수 계산 추가
      var days = Math.floor(distance / (1000 * 60 * 60 * 24)).toString(); // 남은 일 수
