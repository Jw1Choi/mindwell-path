$(function () {
  var eventDate = new Date("2025-07-15T15:00:00+09:00"); // 7/15 오후 3시
  var today = new Date();
  var year = today.getFullYear();
  var month = today.getMonth() + 1;
  var day = today.getDate();

  var countDownDate = new Date("2025-07-15T00:00:00+09:00").getTime(); // 7/15 자정 기준
  ...
  var x = setInterval(function () {
    ...
    if (
      ...
      nowDate.getMonth() === 6 && // 7월 → 6 (0부터 시작)
      nowDate.getDate() === 15 &&
      nowDate < eventDate
    ) {
      clearInterval(x);
