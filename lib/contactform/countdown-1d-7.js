$(function () {
    var targetDate = new Date("2025-06-22T23:59:00+09:00"); // 마감 시각
    var today      = new Date("2025-05-22T23:59:00+09:00");
    ...
    var x = setInterval(function () {
      ...
      if (distance < 0) {
        ...
        $("#choice .faq-card").eq(1).hide(); // 현장 결제
  
        // 3) 설명 문구 교체
        $("#choice .faq-subtext").html("신청이 마감되었습니다.");
