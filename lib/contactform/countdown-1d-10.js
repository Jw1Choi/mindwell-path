$(function () {
  var eventDate = new Date("2026-5-9T14:00:00+09:00"); // 5/9 오후 2시
  var today = new Date();
  var year = today.getFullYear();
  var month = today.getMonth() + 1;
  var day = today.getDate();

  var countDownDate = new Date("2026-5-9T14:00:00+09:00").getTime(); // 5/9 오후 2시
  ...
  var x = setInterval(function () {
    ...
    // ────────── 5월 9일 자정~오후 2시 사이 ──────────
    var onSiteStart = new Date("2026-5-9T00:00:00+09:00");
    if (nowDate >= onSiteStart && nowDate < eventDate) {
      clearInterval(x);
      $("#day, #day1").empty();
      $("#countdown, #countdown1")
        .text("현장 참가만 가능합니다.")
